...
if docker tag ghcr.io/wonderalice/modified-reiverr:latest wonderalice/modified-reiverr:v1.2.1; then
...
if docker push wonderalice/modified-reiverr:v1.2.1; then
